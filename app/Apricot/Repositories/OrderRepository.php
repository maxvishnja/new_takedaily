...
class OrderRepository
{
    ...
    public static function getPaidOrder($year, $month){
	    ...
	    $ordersDK = Order::where('currency', '=', 'DKK')->whereYear('created_at', '=', $year)->whereMonth('created_at', '=', $month)->whereNull('repeat')->sum('total');

	    $ordersEUR = Order::where('currency', '=', 'EUR')->whereYear('created_at', '=', $year)->whereMonth('created_at', '=', $month)->whereNull('repeat')->sum('total');
