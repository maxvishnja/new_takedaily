...
//			$this->setAdvise( '3d', trans( 'flow.combinations.3.d' ) );
		...
		if ( CombinationChecker::isAllowed( $this->groupOne, $this->groupTwo, 'b' ) && isset( $data->gender, $data->age, $data->foods, $data->locale ) &&
		     (
			     (
				     $data->locale === 'nl' &&
				     ( ( $data->foods->wheat == '1' || $data->foods->wheat == '2' )
				       || ( $data->gender == '1' && $data->foods->bread != '5' && $data->foods->wheat == '2' )
				       || ( $data->gender == '2' && $data->foods->wheat == '2' && ($data->foods->bread == '1' || $data->foods->bread == '2' || $data->foods->bread == '3'))
