<div data-step="3" class="step">
	...
	<div data-sub-step="3" class="sub_step">
		...
		<div class="sub_step_answers">
			...
			@if(trans('flow.questions.3-3.options.4') != '' && !empty(trans('flow.questions.3-3.options.4')) && !is_null(trans('flow.questions.3-3.options.4')))
			<label>
			...
			@endif
			@if(trans('flow.questions.3-3.options.5') != '' && !empty(trans('flow.questions.3-3.options.5')) && !is_null(trans('flow.questions.3-3.options.5')))
			<label>
	...
	<div data-sub-step="8" class="sub_step">
		...
		<div class="sub_step_answers">
			...
			@if(trans('flow.questions.3-8.options.4') != '' && !empty(trans('flow.questions.3-8.options.4')) && !is_null(trans('flow.questions.3-8.options.4')))
				<label>
