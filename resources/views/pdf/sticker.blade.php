...
<div style="width: 100%; height: 100%;  padding: 1mm;">
	...
	<div class="vitamins">
		@if($customer->hasPlan() )
			@foreach($customer->getVitaminModels() as $vitaminModel)
				...
				<div class="vitamin" >
					...
					<div style="margin: 4pt 0; font-size: 6.0pt; line-height: 1.2; color: #1A8562;">
						...
						@if(trans("label-{$vitaminModel->code}.disclaimer_EPA_en_DHA") != "label-{$vitaminModel->code}.disclaimer_EPA_en_DHA")
							<p style="line-height: 1.1; font-weight: 200; color: #1A8562; font-size: 6.0pt; margin: 4pt 0 0;font-style:italic">{!! trans("label-{$vitaminModel->code}.disclaimer_EPA_en_DHA") !!}</p>
						@endif
					...
					@if(is_array(trans("label-{$vitaminModel->code}.first-vitamins")) && count(trans("label-{$vitaminModel->code}.first-vitamins")) > 0)
						<table style="width: 100%;">
							<thead>
							<tr style="font-weight: bold;font-size: 6.0pt; color: #1A8562;">
							...
							@foreach(collect(trans("label-{$vitaminModel->code}.first-vitamins"))->sortBy('name', SORT_NATURAL) as $vitamin)
								<tr>
									<td style="text-align: left; font-size: 6.0pt;">{{ isset($vitamin['name']) ? $vitamin['name'] : '' }}</td>
									<td style="text-align: center; font-size: 6.0pt;">{{ isset($vitamin['amount']) ? $vitamin['amount'] : '' }}</td>
									<td style="text-align: right; font-size: 6.0pt;">{{ isset($vitamin['percent']) ? $vitamin['percent'] : '' }}</td>
								</tr>
							@endforeach
							</tbody>
						</table>
					...
					@if(is_array(trans("label-{$vitaminModel->code}.vitamins")) && count(trans("label-{$vitaminModel->code}.vitamins")) > 0)
						<table style="width: 100%;">
							<thead>
							<tr style="font-weight: bold;font-size: 6.0pt; color: #1A8562;">
								<th style="text-align: left;width: 50%; font-size: 6.0pt;">{{ trans('label-product.titles.vitamins') }}</th>
								<th style="text-align: center;width: 30%; font-size: 6.0pt;">{{ trans('label-product.titles.amount') }}</th>
								<th style="text-align: right; font-size: 6.0pt;">{{ trans('label-product.titles.percent') }}</th>
							</tr>
							</thead>
							<tbody style="font-size: 6pt; color:#1A8562;line-height: 1;">
					...
					@if(is_array(trans("label-{$vitaminModel->code}.minerals")) && count(trans("label-{$vitaminModel->code}.minerals")) > 0)
						<table style="width: 100%;">
							<thead>
							<tr style="font-weight: bold;font-size: 6.0pt; color: #1A8562;">
								<th style="text-align: left; width: 50%; font-size: 6.0pt;">{{ trans('label-product.titles.minerals') }}</th>
								<th style="text-align: center; width: 30%; font-size: 6.0pt;">{{ trans('label-product.titles.amount') }}</th>
								<th style="text-align: right; font-size: 6.0pt;">{{ trans('label-product.titles.percent') }}</th>
							</tr>
							</thead>
					...
					@if(is_array(trans("label-{$vitaminModel->code}.other-vitamins")) && count(trans("label-{$vitaminModel->code}.other-vitamins")) > 0)
						<table style="width: 100%;">
							...
							<tbody style="line-height: 1;font-size: 6.0pt; color:#1A8562;">
					...
					@endif
					<p style="line-height: 1.1; font-weight: 200; color: #1A8562; font-size: 6.0pt; margin: 2pt 0 0;">{{ trans('label-product.RI') }}</p>
					<p style="line-height: 1.1; font-weight: 200; color: #1A8562; font-size: 6.0pt; margin: 2pt 0 0;"><strong>{{ trans('label-product.ingredients') }}:</strong> {!! trans("label-{$vitaminModel->code}.ingredients") !!}</p>

					@if(trans("label-{$vitaminModel->code}.Allergener") != '' && trans("label-{$vitaminModel->code}.Allergener") != "label-{$vitaminModel->code}.Allergener")
						<p style="line-height: 1.1; font-weight: 200; color: #1A8562; font-size: 6.0pt; margin: 2pt 0 0;"><strong>{{ trans('label-product.Allergener') }}:</strong> {!! trans("label-{$vitaminModel->code}.Allergener") !!}</p>
					@endif
					...
					@if(trans("label-{$vitaminModel->code}.Disclaimer_warningage") != '' && trans("label-{$vitaminModel->code}.Disclaimer_warningage") != "label-{$vitaminModel->code}.Disclaimer_warningage")
						<p style="line-height: 1.1; font-weight: 200; color: #1A8562; font-size: 6.0pt; margin: 2pt 0 0;">{!! trans("label-{$vitaminModel->code}.Disclaimer_warningage") !!}</p>
					@endif
					...
					@if(trans("label-{$vitaminModel->code}.disclaimer_colorants") != '' && trans("label-{$vitaminModel->code}.disclaimer_colorants") != "label-{$vitaminModel->code}.disclaimer_colorants")
						<p style="line-height: 1.1; font-weight: 200; color: #1A8562; font-size: 6.0pt; margin: 2pt 0 0;">{!! trans("label-{$vitaminModel->code}.disclaimer_colorants") !!}</p>
					@endif
					@if(trans("label-{$vitaminModel->code}.disclaimer") != '')
						...
						@endif
						<p style="line-height: 1.1; font-weight: 200; color: #1A8562; font-size: 6.0pt; margin: 4pt 0 0;font-style:italic">{!! trans("label-{$vitaminModel->code}.disclaimer") !!}</p>
					@endif

					<div style="font-size: 6.0pt;color: #1A8562; margin-top: 1pt; font-weight: 200; ">
		...
		<div style="text-align: center;  font-size: 6.0pt;  padding:0 0 0 12pt; color: #1A8562">
			@if($customer->getLocale() == 'da')
			{{ trans('label-product.pill_color_reason') }}
			@endif
		</div>

	<div style="font-weight: 200;font-size: 6.0pt;color: #1A8562;line-height: 1; position: relative; padding:0 0 0 12pt; margin-top:5pt; text-align: center">
