...
return array (
    'header' =>
        array (
            'title-1' => 'En bedre start på dagen med daglige vitaminer',
            'intro' => 'Tag vores GRATIS test eller vælg selv dine vitaminer, mineraler og Omega-3.Der er ingen binding og prisen er kun 149 kr./md.',
...
<a href="/our-products" class="button button--rounded button--medium button--green m-t-30">Få mere viden</a>',
    ...
    'take-test' => 'Tag testen',

    'reviews' => [
        'title' => 'Vores medlemmer elsker os'
    ],

    'choose' => [
        'title'        => 'Hvorfor vælge TakeDaily',
        'block1-title' => 'Tag vitamintesten',
        'block1-text'  => 'Vores dygtige diætister står bag vitamintesten. Den tager 2 minutter 
at gennemføre, og resultatet gør det muligt at skræddersy TakeDaily til dig.',
        'block2-title' => 'Vi skræddersyr dit TakeDaily',
        'block2-text'  => 'Vi udvælger vitaminer og mineraler, som du har brug for – i de rette koncentrationer. Har du spørgsmål, sidder vores ernæringsekperter klar til at hjælpe dig.',
        'block3-title' => 'Du modtager din æske',
        'block3-text'  => 'Den første TakeDaily-æske lander i din postkasse og indeholder vitaminer, mineraler og Omega 3 til 28 dage. Hver 4. uge sender vi en ny æske til dig.'
    ],

    'compromises' => [
        'title'        => 'Kompromisløshed',
        'subtitle'     => 'Hos TakeDaily er vi kompromisløse. Vores ambition har været at skabe og levere de reneste produkter til vores medlemmer',
        'icons' => [
            'plantbased'   => '&nbsp;&nbsp;100% <br> plantebaserede',
            'iso'          => 'ISO <br> certificeret',
            'nordic'       => 'Nordisk <br> samarbejde',
            'fos'          => 'Friend of the sea Godkendt',
            'glutenfree'   => 'Glutenfri<br>&nbsp;',
            'laktosefri'   => 'Laktosefri<br>&nbsp;',
            'allergifri'   => 'Allergifri<br>&nbsp;',
            'gmo'          => 'GMO fri<br>&nbsp;',
        ]
    ],

    'mosaic' => [
        'block1_h3'  => 'Til punkt og prikke',
        'block1_txt' => 'TakeDaily er vitaminer og kosttilskud af høj kvalitet med rene, aktive ingredienser – alle videnskabeligt dokumenteret. Vores leverandører og de grundstoffer, vi anvender, er godkendt af EU.<br><br>
Og alle formuleringerne er i overensstemmelse med reglerne for kosttilskud, som er defineret af EFSA (European Food Safety Authority) og de nordiske kostråd (NNR). Vores produktions- og pakkefacilitet er ISO 22000:2005 certificeret.',

        'block2_h3'  => 'Naturtro',
        'block2_txt' => 'Vi går altid efter de mest naturlige og veldokumenterede råvarer, og derfor er vores vitaminer, mineraler og Omega 3-kapsler helt uden konserveringsmidler. <br><br> 
De er også både allergene- og GMO-fri (indeholder ikke gen-modificerede organismer). Vores kapsler, der indeholder Omega 3-fiskeolie, består af gelatine, mens alle andre kapsler er 100 % plantebaserede.'
    ],

    'enjoy' => [
        'title' => 'Til glæde for dig',
        'p1'    => 'Vores professionelle diætister og ernæringseksperter giver dig gratis rådgivning',
        'p2'    => 'Vi bruger så naturlige råvarer som muligt, og vores kapsler er 100 % plantebaserede.',
        'p3'    => 'Vi har udviklet en algoritme, som gør det muligt at tilpasse den rette mængde vitaminer, mineraler og omega-3 til dig.',
        'p4'    => 'Vi springer alle de dyre mellemled over og leverer direkte fra fabrikken til din dør.',
    ],

    'packaging' => [
        'title'    => 'Kender du dit vitamin behov?',
        'intro'    => '- Så kan du nemt og enkelt sammensætte din egen pakke',
        'btn'      => 'Vælg selv dine vitaminer'
