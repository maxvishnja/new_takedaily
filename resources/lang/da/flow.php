...
',
    ...
    array (
      ...
      'text' => 'Motion er både godt for din sundhed og dit velbefindende. Hvis du dyrker meget motion, har du brug for nogle ekstra vitaminer og mineraler. B-vitaminer og jern er vigtigt for dit energiniveau og din ydeevne.',
      'options' => 
      array (
        1 => 'Sjældent',
        2 => 'Én gang om ugen',
    ...
    array (
      ...
      'text' => 'I en stresset periode har du brug for lidt ekstra vitaminer, som kan hjælpe dig til at slappe af. B-vitamin giver ro på kroppen og hjælper dit nervesystem og immunforsvar med at fungere optimalt.',
      'options' => 
      array (
        1 => 'Ja',
        2 => 'Nej',
...
',
    ...
    '3-3' => 
    array (
      'title' => 'Hvor meget brød spiser du om dagen?',
      'text' => 'Én portion havregrød, muesli eller lignende tæller for én skive brød.<br/><br/>Brød er en vigtig kilde til B-vitamin, jern og kostfibre. Vælg fuldkorn. Det mætter rigtig godt. Det får
    ...
    '3-4' => 
    array (
      'title' => 'Bruger du smør eller margarine på brødet og i din madlavning?',
      'text' => 'Margarine er en vigtige kilder til A- og D-vitamin, og smør er en god kilde til A-vitamin. Begge vitaminer er vigtige for kroppens immunforsvar.
',
      'options' => 
      array (
        1 => 'Ja',
