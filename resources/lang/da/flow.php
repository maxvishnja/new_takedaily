  ...
  array (
    ...
    array (
      ...
      'text' => 'Nogle vitaminer og mineraler skal du have flere af, når du er gravid eller gerne vil være det.
							...
							uger inde i graviditeten. Folsyre kan du uden problemer tage gennem hele graviditeten. Folsyre er vigtigt, når barnets centralnervesystem udvikles.
							<br/><br/>
    ...
    array (
      ...
      'text' => 'Motion er godt for både din sundhed og dit velbefindende. Hvis du dyrker meget motion, har du brug for nogle ekstra vitaminer og mineraler. B-vitaminer og jern er vigtigt for dit energiniveau og din ydeevne.',
      'options' => 
      array (
        1 => 'Sjældent',
        2 => 'Én gang om ugen',
    ...
    array (
      ...
      'text' => 'I en stresset periode har du brug for lidt ekstra vitaminer, som kan hjælpe dig til at slappe af. B-vitaminer giver ro på kroppen og hjælper dit nervesystem og immunforsvar med at fungere optimalt.',
      'options' => 
      array (
        1 => 'Ja',
        2 => 'Nej',
...
',
      ...
      'C' => '<span v-show="user_data.sports == 4">
							...
							<span v-show="user_data.lacks_energy < 3 || user_data.stressed == 1">
								Når du føler dig træt og mangler energi, mangler du ofte B-vitaminer. Både B1, B2 , B3, B5 og B6 spiller en afgørende rolle for
    ...
    array (
      ...
      'b' => '<span v-show="user_data.foods.bread == 1">
					...
					<span v-show="user_data.foods.wheat == 1">
						Du spiser ikke mange kartofler, ris, pasta eller lignende, og derfor går din krop glip af  nogle gode kulhydrater, som er en vigtig kilde til
...
<span v-show="user_data.vegetarian == 1">
      ...
      'e' => 'Du spiser ikke nok fed fisk, og derfor bliver din krop snydt for de sunde fiskeolier med Omega-3 fedtsyrer og vitaminer som
						...
						er du sikker på, at de mineraler og vitaminer vi sender til dig, indeholder lige præcis de doser, du har brug for.',
      'f' => 'Din daglige kost indeholder ikke nok smør eller margarine som er vigtige kilder til A-vitamin og D-vitamin. Du har brug
  ...
  array (
    ...
    array (
      ...
      'C' => 'Energy Support er et tilskud med netop de vitaminer og mineraler, der bidrager til at du kan yde dit maksimale, når du træner eller har travlt, og hjælper til at reducere følelsen af træthed og udmattelse.',
    ...
    3 => 
    array (
      'a' => 'No Veggie or Fruit Fan indeholder beta-caroten, B11-vitamin (folsyre), C-vitamin, fosfor og kalium. Tilskuddet supplerer din multivitamin med de essentielle vitaminer og mineraler, der normalt findes i frugt og grøntsager.',
      ...
      'd' => 'I Don\'t Eat Meat er fremstillet specielt til vegetarer, veganere og folk, der ikke spiser kød. Tilskuddet supplerer således din multivitamin med de essentielle vitaminer og mineraler, der normalt findes i kød og kødprodukter, og som en vegetarisk kost indeholder for lidt af.',
...
',
  ...
  array (
    ...
    'days' => 
    array (
      'back' => 'Gå tilbage til måneder',
    ),
    'months' => 
    array (
      'back' => 'Gå tilbage til år',
    ),
  ),
  'show' => 
  array (
