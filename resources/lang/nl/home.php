  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          'title' => 'Doe de test',
          'text' => 'Vertel ons iets over jezelf, jouw levensstijl en voedingspatroon. Het duurt slechts enkele minuten om de vragen te beantwoorden.',
        ),
        'two' => 
        array (
          'title' => 'Krijg persoonlijk advies',
          'text' => 'Wij selecteren de voedingssupplementen (met vitamines en mineralen) die aansluiten op jouw persoonlijke behoefte.',
        ),
        'three' => 
        array (
...
<P>Jouw TakeDaily pakket ontvang je iedere vier weken via de post. Gratis bezorgd!</ P>',
  ...
  array (
    'one' => 
    array (
      'body' => '<p>Heb je vragen of wens je hulp bij het doorlopen van de vragenlijst? Ons team met diëtisten en voedingsdeskundigen staat geheel tot jouw beschikking! Wij zijn op werkdagen bereikbaar van 09:00-17:00 uur via <a href="tel:+4570605015">020 2382580</a>. Je kunt ons ook een e-mail sturen via <a href="mailto:info@takedaily.nl">info@takedaily.nl</a>.</p>

<a href="/about-us" class="button button--rounded button--medium button--green m-t-30">Ontmoet ons team</a>',
      'title' => 'Team met diëtisten en voedingsdeskundigen',
      'below_image' => 'Marie-Louise, voedingsdeskundige',
    ),
    'two' => 
    array (
      'body' => '<p>TakeDaily voedingssupplementen zijn van hoogwaardige kwaliteit, bestaande uit zuivere en bewezen ingrediënten. Onze producten zijn samengesteld op basis van de laatste wetenschappelijke inzichten op het gebied van voedingsstoffen en gezondheid. Om actief te kunnen blijven inspelen op deze ontwikkelingen, werken wij samen met een team van voedingsprofessionals. </p>
