...
Zuivelproducten zijn een belangrijke bron van onder andere calcium. Calcium is van belang voor het behoud van sterke botten en soepele spieren.',
    ...
    '3-1' => 
    array (
      'title' => 'Hoeveel gram groenten eet je dagelijks?',
      'text' => 'Groenten zijn een belangrijke bron van foliumzuur, vitamine C en kalium.',
      'options' => 
      array (
        1 => 'Nooit',
        2 => '100 gram',
    ...
    '3-4' => 
    array (
      'title' => 'Gebruik je halvarine/margarine/boter op je brood of tijdens het koken?',
      'text' => 'Halvarine en margarine zijn belangrijke bronnen van vitamine A en D. Boter is een belangrijke bron van vitamine A. Oliën bevatten vitamine E, maar geen vitamine A en D. Vitamine A en D hebben een positieve invloed op ons immuunsysteem.',
      'options' => 
      array (
        1 => 'Ja',
        2 => 'Nee',
...
De Multi Vitamine D+ Extra bevat extra vitamine D. Voor mannen en vrouwen vanaf 70 jaar zijn er namelijk overtuigende aanwijzingen uit onderzoek dat extra vitamine D per dag het risico op botbreuken kan verlagen en het advies van de Gezondheidsraad is om extra vitamine D te gebruiken.',
    ...
    2 => 
    array (
      'A' => 'Je bent zwanger of hebt een zwangerschapswens.TakeDaily zorgt ervoor dat jij en jouw baby de extra vitamines en mineralen krijgen die jullie nodig hebben.
<br/>
Tijdens de zwangerschap, is het van belang om een supplement met 10 microgram vitamine D te gebruiken voor een goede groei van jouw kindje. Visolie ...
<br/>
...
De B-vitamines (B1, B2, B3, B5, B6, B12) spelen een belangrijke rol in de energiestofwisseling van jouw lichaam. Een tekort aan deze vitamines kan leiden tot vermoeidheid en een laag energieniveau. In stressvolle tijden kunnen extra B-vitamines bijdragen aan de weerstand tegen stress en een hele geest. </ span>',
...
Vlees(producten) bevat veel ijzer, vitamine B1 en B12. Als vegetariër of veganist is het belangrijk geen tekorten te ontwikkelen aan deze vitamines en mineralen, daar zij onder andere een belangrijke rol spelen in de energiestofwisseling van ons lichaam.
</span>',
...
<span class="icon icon-general-health-flow flow-promise-icon"></span> <div class="flow-promise-text">Voor het ondersteunen van een optimale gezondheid</div>',
      'basic-10-d' => 'De Multi Vitamine D+ vormt de basis van jouw persoonlijke TakeDaily pakket. Het bevat een uitgebalanceerde combinatie van essentiële vitaminen en mineralen met 10 microgram vitamine D</div>
...
<div class="clear"></div><span class="icon icon-brain-cog-flow flow-promise-icon"></span> <div class="flow-promise-text">Draagt bij tot de instandhouding van de normale hersenfunctie en een normaal gezichtsvermogen**</div>',
  ...
  array (
    ...
    'text' => 'Wil je graag dat wij je bellen voor persoonlijk advies? Vermeld dan hieronder jouw telefoonnummer en de tijd dat je gebeld wenst te worden.',
    'deny' => 'Nee, bedankt. Sluit dit bericht.',
    'options' => 
    array (
      0 => '09:00 - 11:00 uur',
      1 => '11:00 - 13:00 uur',
